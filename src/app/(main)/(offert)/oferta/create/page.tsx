  ...
  return (
    <div className="max-xl:flex-col max-xl:gap-3 flex gap-[46px] w-full"> 
      ...
      <div className="flex flex-col gap-8 w-[260px] min-w-0">
        <section className="max-xl:hidden  p-3 bg-white border border-cinza-forelight rounded-lg font-bold text-preto flex-col gap-3 flex">
        ...
        <button
          ...
          className="p-3 hover:bg-[#5095ca] hover:scale-[102%] transition-all cursor-pointer rounded-lg flex justify-between items-center bg-azul font-bold text-white w-full disabled:opacity-50"
        >
